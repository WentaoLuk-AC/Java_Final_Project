...
public class TestBloodDonation {
    ...
    @Test
    public void test01_admin_read_all_blood_donation() throws JsonMappingException, JsonProcessingException {
...
//		assertThat(donationRecords, is(not(empty())));
    ...
    @Test
    public void test02_user_read_all_blood_donation() throws JsonMappingException, JsonProcessingException {
