...
public class RestConfig extends Application {
	...
	/*
	 * Without the following 'feature', the default Serialization/Deserialization
	 * for Jakarta EE 8 is JSON-B via a project called 'Yasson'.
	 * 
	 * However Yasson does not 'nicely' handle a variety of issues ... so substitute
	 * a non-standard (but much more popular!) package called 'Jackson'
	 */
	...
	public Map<String, Object> getProperties() {
		...
		// add x-jersey-tracing tracing headers Note: if more than 100 trace messages,
		// need to alter configuration to allow for more
